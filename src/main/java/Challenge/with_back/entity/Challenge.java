...
public class Challenge extends BasicEntity
{
    ...
    @Builder
    public Challenge(User superAdmin, String iconUrl, ChallengeColorTheme colorTheme, String name, String description, int goalCount, ChallengeUnit unit, boolean isPublic, int maxParticipantCount, int countCurrentParticipant, int countPhase, LocalDate lastActiveDate) {
